...
public class AssociateController {
	...
	@RequestMapping(value = "/associate/{id}", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/associate/{id}", method = RequestMethod.DELETE)
	...
	@RequestMapping(value = "/associate", method = RequestMethod.GET, produces = "application/json")
	public @ResponseBody ResponseEntity<List<Associates>> getAssociateDetails(@RequestParam("name") String name/*,@RequestParam("specialization") String specialization*/)
			throws Exception {
